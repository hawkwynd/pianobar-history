...
$output         = [];
$bandsToFilter  = array('Boston', 'Styx', 'Incubus', 'Eagles', 'Kenny Wayne Shepherd', 'Journey', 'Chicago', 'Saga','A Flock of Seagulls','John Mayall & The Bluesbreakers', 'Tom Petty And The Hearbreakers');
$tz             = 'America/Chicago';
$timestamp      = time();
